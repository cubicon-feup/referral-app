defmodule AppWeb.PaymentControllerTest do
  ...
  @create_attrs %{paid: true, requestDate: ~N[2010-04-17 14:00:00.000000], value: "120.5"}
  ...
  describe "create payment" do
    test "renders payment when data is valid", %{conn: conn} do
      ...
      assert json_response(conn, 200)["data"] == %{
        "id" => id,
        "paid" => true,
        "requestDate" => ~N[2010-04-17 14:00:00.000000],
        "value" => "120.5"}
    end
  ...
  describe "update payment" do
    ...
    test "renders payment when data is valid", %{conn: conn, payment: %Payment{id: id} = payment} do
      ...
      assert json_response(conn, 200)["data"] == %{
        "id" => id,
        "paid" => false,
        "requestDate" => ~N[2011-05-18 15:01:01.000000],
        "value" => "456.7"}
    end
