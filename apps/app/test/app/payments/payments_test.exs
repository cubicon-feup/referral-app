defmodule App.PaymentsTest do
  ...
  describe "payments" do
    ...
    @valid_attrs %{paid: true, requestDate: ~N[2010-04-17 14:00:00.000000], value: "120.5"}
    @update_attrs %{paid: false, requestDate: ~N[2011-05-18 15:01:01.000000], value: "456.7"}
    @invalid_attrs %{paid: nil, requestDate: nil, value: nil}
    ...
    test "create_payment/1 with valid data creates a payment" do
      ...
      assert payment.requestDate == ~N[2010-04-17 14:00:00.000000]
    ...
    test "update_payment/2 with valid data updates the payment" do
      ...
      assert payment.requestDate == ~N[2011-05-18 15:01:01.000000]
