...
user_create_attrs = %{date_of_birth: ~D[2010-04-17], deleted: true, email: "mail@mail.com", name: "John Doe", password: "password", picture_path: nil, privileges_level: "user"}
brand_create_attrs = %{api_key: "e1c4afd5632958dd66626a3257ac72d7", api_password: "b36782cbdc2d7991f2c804bcd63a9246", hostname: "duarte-store-29.myshopify.com", name: "Brandify"}


{:ok, user} = App.Influencers.create_influencer(user_create_attrs)
